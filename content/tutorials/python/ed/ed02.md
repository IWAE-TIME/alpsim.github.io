...
#### Using Python
To set up and run the simulation in Python we use the script [`tutorial2a.py`](https://github.com/ALPSim/ALPS/blob/master/tutorials/ed-02-gaps/tutorial2a.py). The first parts of this script imports the required modules, prepares the input files as a list of Python dictionaries, writes the input files and runs the application
